...
VL_MODULE(Vriscv_top) {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ riscv_top__DOT__o_alu_ctrl_e;
        CData/*0:0*/ riscv_top__DOT__o_alu_src_e_a;
        CData/*0:0*/ riscv_top__DOT__o_alu_src_e_b;
        CData/*4:0*/ riscv_top__DOT__o_rs_1e;
        CData/*4:0*/ riscv_top__DOT__o_rs_2e;
        CData/*4:0*/ riscv_top__DOT__o_rd_e;
        CData/*4:0*/ riscv_top__DOT__o_rd_w;
        CData/*0:0*/ riscv_top__DOT__o_reg_write_w;
        CData/*0:0*/ riscv_top__DOT__o_flush_e;
        CData/*0:0*/ riscv_top__DOT__o_zero_condition_e;
        CData/*2:0*/ riscv_top__DOT__o_funct3_e;
        CData/*3:0*/ riscv_top__DOT__o_ctrl_mem_byte_sel_e;
        CData/*0:0*/ riscv_top__DOT__o_alu_jalr_e;
        CData/*0:0*/ riscv_top__DOT__o_reg_write_m;
        CData/*1:0*/ riscv_top__DOT__o_result_src_m;
        CData/*4:0*/ riscv_top__DOT__o_rd_m;
        CData/*1:0*/ riscv_top__DOT__o_forward_ae;
        CData/*1:0*/ riscv_top__DOT__o_forward_be;
        CData/*2:0*/ riscv_top__DOT__o_funct3_m;
        CData/*1:0*/ riscv_top__DOT__o_result_src_w;
        ...
        CData/*0:0*/ riscv_top__DOT__u_riscv_hazard__DOT__lw_stall;
